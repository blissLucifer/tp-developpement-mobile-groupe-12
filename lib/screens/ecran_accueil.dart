        ...
        // AnimatedContainer anime la couleur de fond selon la temperature
          ...
          decoration: BoxDecoration(
            color: () {
              ...
              if (temp < 20) return Colors.blue.shade100;    // T < 20°C : frais
              if (temp < 30) return Colors.orange.shade100;  // 20°C <= T < 30°C : tempere
                      ...
                      Hero(
                        ...
                        child: RotationTransition(
                          ...
                          child: AnimatedContainer(
                            ...
                            width: (vm.meteoActuelle?.temperature ?? 0) > 30 ? 120 : 80,
                            height: (vm.meteoActuelle?.temperature ?? 0) > 30 ? 120 : 80,
                            child: Icon(
                              _iconeMeteo(vm.villeSelectionnee?.condition ?? ''),
                              size: (vm.meteoActuelle?.temperature ?? 0) > 30 ? 120 : 80,
                              color: Colors.orange,
                            ),
                          ),
                        ),
                    ...
                    return Column(children: [
                      ...
                      AnimatedSwitcher(
                        ...
                        child: Text(
                          ...
                          key: ValueKey(vm.villeSelectionnee?.nom), // IMPORTANT : detecte le changement
