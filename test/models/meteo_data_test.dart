...
void main() {
  group('MeteoData', () {
    ...
    test('conditionTexte retourne Ensoleille pour code 0', () {
      final meteo = MeteoData(temperature: 30, humidite: 60, weatherCode: 0, time: '2026-06-27T10:00');
      expect(meteo.conditionTexte, equals('Ensoleillé')); // accent !
    });

    // Test 3 : complété
    test('conditionTexte retourne Pluvieux pour code 61', () {
      final meteo = MeteoData(temperature: 25, humidite: 80, weatherCode: 61, time: '2026-06-27T10:00');
    ...
    test('conditionTexte retourne Nuageux pour code 1', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 28, humidite: 60, weatherCode: 1, time: '2026-06-27T10:00');
      // ACT + ASSERT
    ...
    test('conditionTexte retourne Nuageux pour code 2', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 28, humidite: 60, weatherCode: 2, time: '2026-06-27T10:00');
      // ACT + ASSERT
      expect(meteo.conditionTexte, equals('Nuageux'));
    });
    ...
    test('conditionTexte retourne Nuageux pour code 3', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 28, humidite: 60, weatherCode: 3, time: '2026-06-27T10:00');
      // ACT + ASSERT
      expect(meteo.conditionTexte, equals('Nuageux'));
    });
    ...
    test('conditionTexte retourne Averses pour code 80', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 24, humidite: 90, weatherCode: 80, time: '2026-06-27T10:00');
      // ACT + ASSERT
    ...
    test('conditionTexte retourne Averses pour code 81', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 24, humidite: 90, weatherCode: 81, time: '2026-06-27T10:00');
      // ACT + ASSERT
      expect(meteo.conditionTexte, equals('Averses'));
    });
    ...
    test('conditionTexte retourne Averses pour code 82', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 24, humidite: 90, weatherCode: 82, time: '2026-06-27T10:00');
      // ACT + ASSERT
      expect(meteo.conditionTexte, equals('Averses'));
    });
    ...
    test('conditionTexte retourne Orageux pour code 95', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 26, humidite: 95, weatherCode: 95, time: '2026-06-27T10:00');
      // ACT + ASSERT
    ...
    test('conditionTexte retourne Orageux pour code 99', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 26, humidite: 95, weatherCode: 99, time: '2026-06-27T10:00');
      // ACT + ASSERT
      expect(meteo.conditionTexte, equals('Orageux'));
    });
    ...
    test('conditionTexte retourne Variable pour code inconnu', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 25, humidite: 70, weatherCode: 10, time: '2026-06-27T10:00');
      // ACT + ASSERT
    ...
    test('estDangereux retourne true si T > 40 ET orage', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 42, humidite: 80, weatherCode: 95, time: '2026-06-27T10:00');
      // ACT + ASSERT
    ...
    test('estDangereux retourne true si T > 40 seul', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 41, humidite: 60, weatherCode: 0, time: '2026-06-27T10:00');
      // ACT + ASSERT
      expect(meteo.estDangereux(), isTrue);
    });
    ...
    test('estDangereux retourne true si orage seul', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 28, humidite: 90, weatherCode: 95, time: '2026-06-27T10:00');
      // ACT + ASSERT
      expect(meteo.estDangereux(), isTrue);
    });
    ...
    test('estDangereux retourne false si normal', () {
      // ARRANGE
      final meteo = MeteoData(temperature: 30, humidite: 70, weatherCode: 3, time: '2026-06-27T10:00');
      // ACT + ASSERT
